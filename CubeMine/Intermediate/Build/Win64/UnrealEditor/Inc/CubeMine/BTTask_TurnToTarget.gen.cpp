...
#include "CubeMine/Public/BTTask_TurnToTarget.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBTTask_TurnToTarget() {}
// Cross Module References
	CUBEMINE_API UClass* Z_Construct_UClass_UBTTask_TurnToTarget_NoRegister();
	CUBEMINE_API UClass* Z_Construct_UClass_UBTTask_TurnToTarget();
...
// End Cross Module References
	...
	template<> CUBEMINE_API UClass* StaticClass<UBTTask_TurnToTarget>()
	{
		return UBTTask_TurnToTarget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UBTTask_TurnToTarget);
	struct Z_CompiledInDeferFile_FID_CubeMine_Source_CubeMine_Public_BTTask_TurnToTarget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CubeMine_Source_CubeMine_Public_BTTask_TurnToTarget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTTask_TurnToTarget, UBTTask_TurnToTarget::StaticClass, TEXT("UBTTask_TurnToTarget"), &Z_Registration_Info_UClass_UBTTask_TurnToTarget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTTask_TurnToTarget), 3133058741U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CubeMine_Source_CubeMine_Public_BTTask_TurnToTarget_h_1722448963(TEXT("/Script/CubeMine"),
		Z_CompiledInDeferFile_FID_CubeMine_Source_CubeMine_Public_BTTask_TurnToTarget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CubeMine_Source_CubeMine_Public_BTTask_TurnToTarget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
